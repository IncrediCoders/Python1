...
* **Unplugged Activities**: One way that kids can learn programming lessons is to further reinforce learning through physical "unplugged" games, where they interact without a computer or device. These Unplugged Activities also help students move around and stay active. Example: [Level 1: Unplugged Activity: Turtle Graphics](https://github.com/IncrediCoders/Python1/wiki/Level-1:-Unplugged-Activity).
* **Rewards**: As a way to reward the reader, when the readers finish a Level, they get to check out that level's Reward page, where they will see how we made the art, characters, games, and more! Make sure you complete the level before you read through the page! Example: [Level 1: Rewards](https://github.com/IncrediCoders/Python1/wiki/Level-1:-Rewards).
...
* **Big Book Buddies**: These are the extra pages that complement and expand on what you'll find in the book!
    * **[What's the Big Idea?](https://github.com/CodaKids/Python1/wiki/What's-the-Big-Idea%3F)** - Why did we make this book?
    * **[The Prestigious Praise Page](https://github.com/IncrediCoders/Python1/wiki/Prestigious-Praise-Page)**: The beginning of the book includes some of our top testimonials... and here are the rest!
    * **[Meet the Technologies](https://github.com/IncrediCoders/Python1/wiki/Meet-the-Technologies)**: Learn more about Python, Pygame, Microsoft Visual Studio Code, and GitHub!
    * **[Code Conventions](https://github.com/IncrediCoders/Python1/wiki/Code-Conventions)**: Why we made the decisions we made for the code concepts, conventions, styles, and formatting.
    * **[Repo Structure](https://github.com/IncrediCoders/Python1/wiki/Repo-Structure)**: Where to find all the files in this GitHub repo, how to navigate the resources, and why we organized the folders like this. 
    * **[Init.py Guide](https://github.com/IncrediCoders/Python1/wiki/Init.py-Guide)**: We made a list of all the input.py files, and we provide a summary of the code that's in each file. 
    * **[Formidable FAQ](https://github.com/IncrediCoders/Python1/wiki/Formidable-FAQ)**: Here are all the answers to your questions!
