...
# Added the images for RAM & ROM and Amphib Ian here
...
text_sidewinder = "I'm SideWinder, from Salt-Snake City, Mewtah. I'm the best at SpaceWars, despite what Bayo thinks. My favorite movie is Snakes on a Glider, my favorite actor is Sylvester Stallion, and my favorite band is Nine-Inch Snails. Jitter Bug has good taste. "
...
# Uncommented the introduction for RAM & ROM and Amphib Ian below
...
while running:
    ...
    for event in EVENTS:
        ...
        if event.type == pygame.KEYDOWN:
            ...
            # Added the if statements for RAM & ROM and Amphib Ian here
