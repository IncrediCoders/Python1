...
class PlayScreen(GameState):
	...
	def start(self, players):
		...
		# Updated the card display data for both players (Hint: look at lines 587-626 in the init.py file)
		...
		# Updated the on deck data for both players (Hint: look at lines 628-679 in the init.py file)
