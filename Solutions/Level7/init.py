...
icon_scratch = pygame.image.load(path.join(assets_path, "IconScratch.png"))
icon_small_basic = pygame.image.load(path.join(assets_path, "IconSmallBasic.png"))
...
cryptic_creeper_img = pygame.image.load(path.join(assets_path, "CrypticCreeper.png")).convert()
emily_airheart_img = pygame.image.load(path.join(assets_path, "EmilyAirHeart.png")).convert()
grafika_turtle_img = pygame.image.load(path.join(assets_path, "GrafikaTurtle.png")).convert()
intelli_scents_img = pygame.image.load(path.join(assets_path, "Intelliscents.png")).convert()
java_lynn_img = pygame.image.load(path.join(assets_path, "JavaLynn.png")).convert()
jitter_bug_img = pygame.image.load(path.join(assets_path, "JitterBug.png")).convert()
justin_timbersnake_img = pygame.image.load(path.join(assets_path, "JustinTimbersnake.png")).convert()
mrs_scratcher_img = pygame.image.load(path.join(assets_path, "MrsScratcher.png")).convert()
paul_python_img = pygame.image.load(path.join(assets_path, "PaulPython.png")).convert()
queen_cobra_img = pygame.image.load(path.join(assets_path, "QueenCobra.png")).convert()
ram_rom_img = pygame.image.load(path.join(assets_path, "RAMandROM.png")).convert()
sidewinder_img = pygame.image.load(path.join(assets_path, "SideWinder.png")).convert()
syntax_turtle_img = pygame.image.load(path.join(assets_path, "SyntaxTurtle.png")).convert()
viralmuto_img = pygame.image.load(path.join(assets_path, "ViralMuto.png")).convert()
virobotica_img = pygame.image.load(path.join(assets_path, "Virobotica.png")).convert()
virobots_img = pygame.image.load(path.join(assets_path, "Virobots.png")).convert()
woodchuck_norris_img = pygame.image.load(path.join(assets_path, "WoodchuckNorris.png")).convert()
