...
def update(delta_time):
    ...
    #Copied the code here for the Player 1 ship to rotate clockwise
    ...
    #Copied the code here for the Player 1 ship to move backward
    elif key_held_down(pygame.K_s):
        MY.player1.add_velocity(MY.player1.rotation, -ship_accel, ship_max_speed)

    #Rotates the Player 2 ship
    #Wrote the code here to rotate the Player 2 ship
    ...
    #Wrote the code here to move the Player 2 ship
