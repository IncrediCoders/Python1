...
def update(delta_time):
    ...
    for projectile in MY.shield_projectiles:
        #TODO: Write code for moving the projectile to the right
        ...
        #TODO: Write code for moving the projectile down
        ...
        #TODO: Write code for moving the projectile to the left
        elif(projectile.location.x <= 480 and projectile.location.x > 320 and projectile.location.y == 400): 
            projectile.location.x -= MY.projectile_velocity
        #TODO: Write code for moving the projectile up
